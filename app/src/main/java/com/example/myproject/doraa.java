...
public class doraa extends AppCompatActivity {
    EditText e1;
    Button b1;
    int t;
    TextView tt1,tu;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doraa);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(e1.getText().toString().isEmpty()){
                    ...
                    tu.setText(str22);
                    long id=helper.insertt("Dora: Seats="+e1.getText().toString(),tu.getText().toString());
                    if(id<=0){
